...
public class SortByPopularityTest extends TestCase {
    ...
    public void testSort() throws Exception {
        ...
        sc = new Scanner(new FileReader("/Users/axelniklasson/dev/blue-java/testing/resources/popularity_sorted.txt"));
        while(sc.hasNextLine()) {
            correct += sc.nextLine();
        }
